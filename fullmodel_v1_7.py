...
params = {
    ...
    "x_A": 0,
    "x_D": 0,
    "x_Y": 0.00398*(10**(0)),  # 0.00398*(10**(-3)),
    "x_W": 0.00398*(10**(0)),  # 0.00398*(10**(-3)),
    "sigma_A": 0,
    "sigma_D": 0,
    "sigma_Y": 0.0062,
    "sigma_W": 0.0062,
...
#     return 4.703283 * eta_B(T, params) + 3.5685
...
class modelCyB(object):
    ...
    def __init__(self):
        ...
        self.toxines = True
        self.max_temp_time = 197.3989
        self.max_temp = 8.8017
        self.min_temp = 7.16188
        self.freq_temp = -0.0172
        self.init_temp = 0
        self.T = 0.0001196470766
        self.labels = False
    ...
    def Temp(self, t):
        # return self.max_temp*np.cos(self.freq_temp*(t-self.max_temp_time+self.init_temp))
        return self.max_temp*np.exp(-self.T*(t % 365 - self.max_temp_time)**2)+self.min_temp
